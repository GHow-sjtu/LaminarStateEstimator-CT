function Points = GenerateEdge2(params)
% [X Y Z theta phi]'
...
% theta: axial angle
% phi: cutting angle position

end_s = acos(h/R);

theta_t = linspace(0,end_s,21);

delta_theta =  theta_t(2)-theta_t(1);   %   -  0.0710
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
theta_t = 0:delta_theta:pi/2;

% theta_t(2)-theta_t(1)    -  0.0785
