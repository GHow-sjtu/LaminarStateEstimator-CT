...
%         count_show = 1;
        for k = 1:numPointLine
            ...
            valid_PCL = CWE_plan(PCLx, cState);             % produce the parameter
...
%             sim_cen_loc(:,k,j,i) = curr_cen;
        ...
        sim_pcl_cen = pointCloud(temp_cen',ones(length(temp_cen),1)*sim_color_cen);
        pcshow(sim_pcl_cen);
        hold on
...
% save result_new0801.mat result_m sim_result cen_loc edge_loc sim_cen_loc sim_edge_loc tran_loc w d
